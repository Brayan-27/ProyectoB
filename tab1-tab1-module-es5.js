...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tab1-tab1-module"], {
  ...
  function srcAppPagesTab1Tab1PageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _providers_access_providers__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../../providers/access-providers */
    "./src/app/providers/access-providers.ts");

    var Tab1Page = /*#__PURE__*/function () {
      function Tab1Page(router, toastCtrl, loadingCtrl, alertCtrl, accsPrvds, storage, navCtrl) {
      ...
      _createClass(Tab1Page, [{
        ...
        value: function ionViewDidEnter() {
          ...
          this.storage.get('storage_xxx').then(function (res) {
            ...
            _this.name = _this.datastorage.your_name;
          });
        }
      }]);
